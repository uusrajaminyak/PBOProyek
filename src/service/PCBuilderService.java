    ...
    public void cekKompatibilitas(List<KomponenPC> keranjang) {
        ...
        if (cpu != null && mobo != null) {
            if (cpu.getSocket().equalsIgnoreCase(mobo.getSocketDukungan())) {
                System.out.println("[AMAN] Socket CPU (" + cpu.getSocket() + ") dan Motherboard COCOK.");
            } else {
                System.out.println("[BAHAYA] SOCKET TIDAK COCOK!");
                System.out.println("CPU butuh: " + cpu.getSocket() + " | MOBO mendukung: " + mobo.getSocketDukungan());
            }
        } else {
            System.out.println("[INFO] Masukkan minimal 1 CPU dan 1 Motherboard untuk analisis.");
        }
    }

    // ==========================================
    // KATEGORI 1: KEBUTUHAN & FUNGSI
    // ==========================================
